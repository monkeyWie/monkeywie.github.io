...
我花费了大量的时间和精力来实现这套扩展系统，希望`Gopeed`能有一个完善的扩展生态，就像油猴那样，目前我开发的几个扩展只是抛砖引玉，比较我一个人的力量还是有限的，希望能有更多感兴趣的同学参与进来开发扩展，让`Gopeed`的功能更加强大，最后的最后，欢迎大家来给[Gopeed](https://github.com/GopeedLab/gopeed)点个 star，谢谢！
